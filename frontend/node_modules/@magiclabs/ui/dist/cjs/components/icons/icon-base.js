...
const MonochromeIcon = /* @__PURE__ */ forwardRefWrapper.forwardRefWrapper('Icon', { inline: true }, (props, externalRef) => {
    var _a, _b;
    ...
    return (React__default["default"].createElement("span", Object.assign({ className: clsx__default["default"]([iconBase["default"].IconBase, inline && iconBase["default"].inline, className]), "aria-hidden": "true" }, otherProps, { ref: externalRef }),
...
const DuotoneIcon = /* @__PURE__ */ forwardRefWrapper.forwardRefWrapper('Icon.Duotone', { inline: true }, (props, externalRef) => {
    var _a, _b, _c, _d;
...
const Icon = /* @__PURE__ */ Object.assign(MonochromeIcon, { Duotone: DuotoneIcon });
// --- Utilities ------------------------------------------------------------ //
/**
