...
const Tab = /* @__PURE__ */ forwardRefWrapper.forwardRefWrapper('Tab', (props, externalRef) => {
    ...
    const isInitialRender = usableReact.useInitialRender();
    React.useEffect(() => {
    ...
    const { isHovered, hoverProps } = reactAria.useHover({ isDisabled: false });
    ...
    return (React__default["default"].createElement(iconBase.IconColorProvider, { colorA: iconColor },
        React__default["default"].createElement("button", Object.assign({ className: clsx__default["default"]([
                tab["default"].Tab,
