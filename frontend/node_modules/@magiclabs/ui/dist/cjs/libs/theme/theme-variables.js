...
function getThemeVariables(theme) {
    ...
    const variables = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, createCSSVariableGroup('primary', theme.rgba.primary)), createCSSVariableGroup('v2secondary', theme.rgba.v2secondary)), createCSSVariableGroup('v2tertiary', theme.rgba.v2tertiary)), createCSSVariableGroup('neutral', theme.rgba.neutral)), createCSSVariableGroup('negative', theme.rgba.negative)), createCSSVariableGroup('secondary', theme.rgba.secondary)), createCSSVariableGroup('tertiary', theme.rgba.tertiary)), createCSSVariableGroup('success', theme.rgba.success)), createCSSVariableGroup('warning', theme.rgba.warning)), createCSSVariableGroup('error', theme.rgba.error)), createCSSVariableGroup('light', theme.rgba.light)), createCSSVariableGroup('dark', theme.rgba.dark)), createCSSVariableGroup('mid', theme.rgba.mid)), { '--mg__font_sans': theme.font.sans, '--mg__font_monospace': theme.font.monospace });
    return {
        variables,
        toCSS() {
