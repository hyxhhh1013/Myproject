...
function createTheme(config) {
    ...
    const v2secondaryColor = Color__default["default"](typeof config.v2secondaryColor === 'string' ? config.v2secondaryColor : config.v2secondaryColor.base);
    const v2tertiaryColor = Color__default["default"](typeof config.v2tertiaryColor === 'string' ? config.v2tertiaryColor : config.v2tertiaryColor.base);
    const neutralColor = Color__default["default"](typeof config.neutralColor === 'string' ? config.neutralColor : config.neutralColor.base);
    const negativeColor = Color__default["default"](typeof config.negativeColor === 'string' ? config.negativeColor : config.negativeColor.base);
    ...
    // Font values
    const sans = (_c = (_b = config.font) === null || _b === void 0 ? void 0 : _b.sans) !== null && _c !== void 0 ? _c : '"Inter", "ProximaNova", -apple-system, "Segoe UI", "Roboto", "Oxygen", "Ubuntu", "Cantarell", "Fira Sans", "Droid Sans", "Helvetica Neue", "Helvetica", "Arial", sans-serif';
