...
var forwardRefWrapper = require('./forward-ref-wrapper.js');
...
function createGenericForwardRefsFactory(allowedTags) {
    const createForwardRefs = (name, defaultPropsOrRender, definitelyRender) => {
        ...
        allowedTags.forEach((tag) => {
            result[tag] = forwardRefWrapper.forwardRefWrapper(`${name}.${tag}`, Object.assign({ component: tag }, defaultProps), render);
        });
        return result;
    };
...
exports.createGenericForwardRefsFactory = createGenericForwardRefsFactory;
