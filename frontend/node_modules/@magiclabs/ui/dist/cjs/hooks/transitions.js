...
function createFramerTransition() {
    const createHook = (variants, reducedMotionVariants) => (targets) => {
        ...
        const prefersReducedMotion = useReducedMotion.useReducedMotion();
        const variantsResolved = React.useMemo(() => (prefersReducedMotion ? Object.assign(Object.assign({}, variants), reducedMotionVariants) : Object.assign({}, variants)), [prefersReducedMotion]);
        const createFramerProps = React.useCallback((custom = {}) => ({ custom, variants: variantsResolved, initial, animate, exit }), [initial, animate, exit, variantsResolved]);
