...
const ToggleButton = /* @__PURE__ */ forwardRefWrapper('ToggleButton', { color: 'primary' }, (props, externalRef) => {
    ...
    return (React.createElement("button", Object.assign({ className: clsx([
            className,
        ...
        React.createElement(AnimatePresence, null, isFocusVisible && React.createElement(motion.span, Object.assign({ "aria-hidden": "true", className: modules_0d6d3c28.focusRing }, getScaleProps(1.2))))));
});
