...
const FlexItem = /* @__PURE__ */ forwardRefWrapper('Flex.Item', (props, externalRef) => {
    const { className, inline } = props, otherProps = __rest(props, ["className", "inline"]);
    return (React.createElement(FlexLayout, Object.assign({ className: clsx([modules_135aa908.FlexItem, className, inline && modules_135aa908.inlineItem]) }, otherProps, { ref: externalRef })));
});
// -------------------------------------------------------------------------- //
const FlexContainer = /* @__PURE__ */ forwardRefWrapper('Flex', (props, externalRef) => {
    const { className, inline } = props, otherProps = __rest(props, ["className", "inline"]);
    return (React.createElement(FlexLayout, Object.assign({ className: clsx([modules_135aa908.FlexContainer, modules_135aa908.FlexItem, className, inline && modules_135aa908.inlineContainer]) }, otherProps, { ref: externalRef })));
});
const FlexRow = /* @__PURE__ */ forwardRefWrapper('Flex.Row', (props, externalRef) => {
...
const FlexColumn = /* @__PURE__ */ forwardRefWrapper('Flex.Column', (props, externalRef) => {
    const { reverse, horizontal, vertical } = props, otherProps = __rest(props, ["reverse", "horizontal", "vertical"]);
