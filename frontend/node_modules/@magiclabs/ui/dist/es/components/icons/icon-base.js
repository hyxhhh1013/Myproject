...
const MonochromeIcon = /* @__PURE__ */ forwardRefWrapper('Icon', { inline: true }, (props, externalRef) => {
    var _a, _b;
    ...
    return (React.createElement("span", Object.assign({ className: clsx([modules_d3c672d4.IconBase, inline && modules_d3c672d4.inline, className]), "aria-hidden": "true" }, otherProps, { ref: externalRef }),
...
const DuotoneIcon = /* @__PURE__ */ forwardRefWrapper('Icon.Duotone', { inline: true }, (props, externalRef) => {
    var _a, _b, _c, _d;
