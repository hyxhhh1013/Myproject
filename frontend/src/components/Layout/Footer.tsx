...
export const Footer = () => {
  return (
    <footer className="bg-white/5 dark:bg-dark-surface border-t border-gray-200 dark:border-gray-800 py-12 transition-colors duration-300">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          &copy; {new Date().getFullYear()} 黄奕�? All rights reserved.
        </p>
      </div>
    </footer>
  );
