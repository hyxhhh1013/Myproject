...
export const MusicSection = () => {
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="relative mb-8 max-w-sm mx-auto">
            ...
            {musicList.slice(1, 4).map((music, index) => (
              ...
              >
                <div className="music-card relative w-full bg-white/5/10 backdrop-blur-sm rounded-lg overflow-hidden shadow-xl">
            ...
            <motion.div
              ...
              className="relative z-10 music-card group relative w-full bg-white/5/10 backdrop-blur-sm rounded-lg overflow-hidden shadow-2xl"
            >
              <div className="relative overflow-hidden">
                <img 
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4">
                  <motion.div
                    className="w-12 h-12 rounded-full bg-white/5/90 flex items-center justify-center text-white"
          ...
          <div className="flex justify-center gap-4">
            <motion.button
              ...
              className="bg-white/5/20 backdrop-blur-sm rounded-full p-3 text-white shadow-lg transition-all duration-300 hover:bg-white/5/30"
              aria-label="Previous"
            >
      ...
      {/* 最受欢迎榜�?*/}
      <div className="mb-6">
        <h3 className="text-xl font-bold text-white mb-4">最受欢�?/h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {popularMusic.map((music, index) => (
            <motion.div
              key={music.id}
              whileHover={{ x: 5 }}
              className="flex items-center gap-3 p-3 bg-white/5/5 backdrop-blur-sm rounded-lg transition-all duration-300 hover:bg-white/5/10"
            >
      ...
      <div className="mt-6 flex flex-col items-center gap-4">
        <div className="flex items-center gap-4">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={handleLike}
            className={`flex items-center gap-2 px-6 py-3 bg-white/5/10 backdrop-blur-sm rounded-full text-sm font-medium transition-all duration-300 shadow-md hover:shadow-lg hover:text-blue-400 transform hover:scale-110 group ${isLiked ? 'text-red-500' : ''}`}
          >
