...
const MessagesManagement: React.FC = () => {
  ...
  const handleBatchDelete = async () => {
    ...
    try {
      ...
      message.success(`已删�?${selectedRowKeys.length} 条留言`);
        ...
        {selectedRowKeys.length > 0 && (
            <div className="bg-blue-50 px-4 py-3 flex items-center justify-between border-b border-blue-100">
                <span className="text-blue-700 text-sm">
                    已�?<span className="font-bold">{selectedRowKeys.length}</span>
                </span>
                <Space size="small">
            ...
            <List
                ...
                renderItem={item => (
                    <List.Item 
                        ...
                        className="cursor-pointer hover:bg-white/5 px-4 py-3 border-b border-white/10 last:border-0"
                    >
