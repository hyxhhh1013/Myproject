    ...
    <div className="flex flex-col md:flex-row items-center justify-between">
      ...
      <div className="md:w-1/2">
        <div className="relative">
          <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full blur-lg opacity-50"></div>
          <img
            src="https://via.placeholder.com/400"
            alt="Profile"
            className="relative w-80 h-80 object-cover rounded-full mx-auto border-4 border-white shadow-lg"
          />
        </div>
      </div>
    </div>
