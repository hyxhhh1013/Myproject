      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="card">
          ...
          <div className="space-y-6">
            <div>
              <h4 className="text-lg font-semibold text-gray-800 mb-2">地址</h4>
              <p className="text-gray-600">北京市朝阳区建国路88号</p>
            </div>
            
            <div>
              <h4 className="text-lg font-semibold text-gray-800 mb-2">邮箱</h4>
              <p className="text-gray-600">zhangsan@example.com</p>
            </div>
            
            <div>
              <h4 className="text-lg font-semibold text-gray-800 mb-2">电话</h4>
              <p className="text-gray-600">138-0013-8000</p>
            </div>
            
            <div>
              <h4 className="text-lg font-semibold text-gray-800 mb-3">社交媒体</h4>
