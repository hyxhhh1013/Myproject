...
router.post('/batch/read', authMiddleware_1.protect, messageController_1.batchMarkAsRead);
router.post('/batch/delete', authMiddleware_1.protect, messageController_1.batchDeleteMessages);
