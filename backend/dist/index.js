...
const travelCityRoutes_1 = __importDefault(require("./routes/travelCityRoutes"));
...
app.use('/api', hobbyRoutes_1.default);
app.use('/api/music', musicRoutes_1.default);
app.use('/api/movies', movieRoutes_1.default);
app.use('/api/travel-cities', travelCityRoutes_1.default);
